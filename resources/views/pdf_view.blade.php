...
<body>
    ...
    <table>
                        ...
                        <table>
                            <tr>
                                        ...
                                        <td style="border: 0px !important; text-align: right;">
                                           {{$request->entrees['personne']['nom']}} {{$request->entrees['personne']['prenom']}}<br>
                                           {{$request->entrees['personne']['adresse']}}<br>
                                           {{$request->entrees['personne']['tel']}}
                                        </td>
                                        <td style="border: 0px !important; text-align: right;">
        ...
        @foreach($request->entrees['lignes'] as $ligne)
        <tr>
    ...
    <p style="margin-left: 80px;">     المجموع : {{$request->entrees['montant_total']}} درهم</p>
    <table>
        <tr>
        ...
        @foreach($request->entrees['avances'] as $avance)
        <tr>
