  ...
  <div class="content">
    <div class="md-layout">
      <div class="md-layout-item md-medium-size-100 md-size-66">
        <form novalidate @submit.prevent="updateSerie" enctype="multipart/form-data">
          <md-card>
  ...
  methods: {
    ...
    updateSerie() {
      ...
      if (!this.$v.$invalid) {
        ...
        formData.append("id", this.serie.id);
        ...
        axios
          .post("api/modifierSerie", formData, config)
          .then(function(response) {
              currentObject.$router.push({ name: "ListeSeries" });
          })
