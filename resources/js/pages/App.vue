<template>
  <div class="centered-container" style="direction: ltr !important;">
    <md-content class="md-elevation-3">

      <div class="title">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkcsCap6oz45Fjrbv5Qs_vcD7HGdu3BxMHdyVq8sGwrNWNE3mtLQ">
        <div class="md-title">Bouzid-Shop</div>
        
      </div>
      <div v-if="error" style="color: red;"><p>لقد أدخلت معلومات خاطئة</p></div>
      ...
      <div class="actions md-layout md-alignment-center-space-between">
        <a href="">نسيت كلمة مرورك؟</a>
        <md-button class="md-raised md-primary" @click="auth">تسجيل الدخول</md-button>
      </div>
      ...
      fetch("api/signin", {
        ...
        .then(data => {
          ...
          if(token){
            ...
            this.login.email = "";
            this.login.password = "";
             this.$notification.error("المعلومات التي أدخلتها خاطئة", {
                timer: 10
              });
          }
        })
